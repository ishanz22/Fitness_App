                ...
                <View style={styles.container}>
                        ...
                        <View style={styles.menuContainer}>
                                ...
                                <View style={styles.menuAndBackContainer}>
                                        ...
                                        {/* menu icon */}
                                        <TouchableOpacity onPress={favouriteHandler} style={styles.menuIconContainer}>
                                                <Image source={ICONS.whiteHeart} style={styles.menuIcon} />
                                        </TouchableOpacity>
                                </View>
                        </View>
                        ...
                        <View style={styles.mainTextContainer}>
                                ...
                                <View style={styles.headerTextContainer}>
                                        <Text numberOfLines={1} style={styles.headerTitle}>Egy recept</Text>
                                        <Text style={styles.headerTimingText}>35 perc</Text>
                                </View>
                                ...
                                <View style={styles.headerTextContainer}>
                                        <View style={styles.starIconContainer}>
                                                <Image source={ICONS.starYellow} style={styles.starIcon} />
                                                <Image source={ICONS.starYellow} style={styles.starIcon} />
                                                <Image source={ICONS.starYellow} style={styles.starIcon} />
                                                <Image source={ICONS.starYellow} style={styles.starIcon} />
                                                <Image source={ICONS.starYellow} style={styles.starIcon} />
                                        ...
                                        <Text style={styles.headerSubText}>250 kalória</Text>
                                </View>
                                ...
                                <ScrollView style={styles.scrollView}>
                                        ...
                                        {/* ingrident */}
                                        <Text style={styles.ingridentText}>Hozzávalók</Text>
                                                        ...
                                                        fakeData && fakeData.map((item, index) => (
                                                                <View key={index}>
                                                                        ...
                                                                        <View style={styles.ingridentListContainer}>
                                                                                <Text numberOfLines={1} style={styles.ingridentSubText}>Hozzávaló 1</Text>
