...
export const httpPut = (requestConfig) => {
    ...
    return async (dispatch) => {
        ...
        const configurations = await getConfigurations('put', url, data, isAuth, isFormData, timeout);
        ...
        axios(configurations)
            ...
            .catch((error) => {
                console.log(error)
                handleErrors(error, dispatch, actionTypes, {forceRequest: () => httpPut(requestConfig)});
            })
    }
}
...
export const httpDelete = (requestConfig) => {
    ...
    return async (dispatch) => {
        ...
        axios(configurations)
            ...
            .catch((error) => {
                console.log(error)
                handleErrors(error, dispatch, actionTypes, {forceRequest: () => httpDelete(requestConfig)});
            })
